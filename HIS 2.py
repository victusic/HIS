...
error = PhotoImage(file="files/texture/vst/res.gif")
...
def nastroiki():
	...
	clq = Radiobutton(bg=color3, relief=RIDGE, activebackground=color1, activeforeground=color3, text="Светлая тема   ", font="Arial 28", fg=color2, value=1, command=cmb)
	clq.place(width=270, height=100, x=20, y=210)
	clq0 = Radiobutton(bg=color3, relief=RIDGE, activebackground=color1, activeforeground=color3, text=" Тёмная тема     ", font="Arial 28", fg=color1, value=2, command=cmd)
	clq0.place(width=270, height=100, x=350, y=210)
...
def prost_slog():
	clean_  = Label(text="пасхалка", bg="white", fg="white", font="Arial 25")
	clean_ .place(width=850, height=250, x=0, y=0)
	clean_  = Label(text="пасхалка", bg="white", fg="white", font="Arial 25")
	clean_ .place(width=850, height=510, x=0, y=0)
	...
	lab.place(width=850, height=40, x=0, y=5)
	global vv
	ov = Label(text="Введите 1-ое слагаемое:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	...
	global vvv
	vo = Label(text="Введите 2-ое слагаемое:", bg="white", fg="black", font="Arial 10", justify=LEFT)
...
def prost_ymnog():
	...
	lab.place(width=850, height=40, x=0, y=5)
	global qq
	ov = Label(text="Введите 1-ый множитель:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	ov.place(width=160, height=20, x=0, y=40)
	qq = Entry( bg="whitesmoke", bd=1, fg="MediumBluE", font="Arial 12", width=20)
	qq.place(width=100, height=16, x=160, y=44)
	global qqq
	vo = Label(text="Введите 2-ой множитель:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	vo.place(width=160, height=20, x=0, y=60)
...
def prost_del():
	...
	lab.place(width=850, height=40, x=0, y=5)
	global ww
	ov = Label(text="Введите делимое:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	ov.place(width=160, height=20, x=0, y=40)
	ww = Entry( bg="whitesmoke", bd=1, fg="MediumBluE", font="Arial 12", width=20)
	ww.place(width=100, height=16, x=160, y=44)
	global www
	vo = Label(text="Введите делитель:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	vo.place(width=160, height=20, x=0, y=60)
...
def prost_vichit():
	...
	lab.place(width=850, height=40, x=0, y=5)
	global ee
	ov = Label(text="Введите 1-ое число:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	ov.place(width=160, height=20, x=0, y=40)
	ee = Entry( bg="whitesmoke", bd=1, fg="MediumBluE", font="Arial 12", width=20)
	ee.place(width=100, height=16, x=160, y=44)
	global eee
	vo = Label(text="Введите 2-ое число:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	vo.place(width=160, height=20, x=0, y=60)
...
def prost_stepen():
	...
	choice = 16
	#Первый фрэйм, ввод чисел
	lab = Label(text="Возведение в степень:", bg="white", fg="MediumBluE", font="Arial 22")
	lab.place(width=850, height=40, x=0, y=5)
	global tt
	ov = Label(text="Введите число:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	...
	global ttt
	vo = Label(text="Введите степень:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	...
	lb = Label(text="Возведенное число:", bg="white", fg="MediumBluE", font="Arial 22")
	lb.place(width=850, height=40, x=0, y=5)
#ИЗВЛЕЧЕНИЕ КОРНЯ
def cluck(): 
	global yy
...
def prost_koren():
	...
	choice = 15
	#Первый фрэйм, ввод чисел
	lab = Label(text="Извлечение корня", bg="white", fg="MediumBluE", font="Arial 22")
	lab.place(width=850, height=40, x=0, y=5)
	global yy
	ov = Label(text="Введите число:", bg="white", fg="black", font="Arial 10", justify=LEFT)
	ov.place(width=97, height=20, x=0, y=40)
	...
	lb = Label(text="Корень числа", bg="white", fg="MediumBluE", font="Arial 22")
	lb.place(width=850, height=40, x=0, y=5)
...
def ff_him():
	global choice
	choice = 0
	nac= Label(text="Выберите тему:", bg="white", fg="MediumBluE", font="Arial 24")
	nac.place(width=850, height=40, x=0, y=0)
	him = IntVar()
	ch1 = Radiobutton(text="Моль", bg="white", font="Arial 12", value=1, justify=LEFT, command=him1,
		activebackground="MediumBluE", activeforeground="white", variable=him)
	ch1.place(width=60, height=20, x=0, y=70)

	ch2 = Radiobutton(text="Молярная масса вещества", bg="white", font="Arial 12", value=2, justify=LEFT, command=him2,
		activebackground="MediumBluE", activeforeground="white", variable=him)
	ch2.place(width=225, height=20, x=0, y=90)

	ch3 = Radiobutton(text="Объём вещества", bg="white", font="Arial 12", value=3, justify=LEFT, command=him3,
		activebackground="MediumBluE", activeforeground="white", variable=him)
	ch3.place(width=150, height=20, x=0, y=110)

	ch4 = Radiobutton(text="Число Авогадро", bg="white", font="Arial 12", value=4, justify=LEFT, command=him4,
		activebackground="MediumBluE", activeforeground="white", variable=him)
	ch4.place(width=150, height=20, x=0, y=130)

def him1():
	f1 = Label(text="n=m\Mr", bg="white", font="Arial 14")
	f1.place(width=850, height=100, x=0, y=50)
def him2():
	f2 = Label(text="m=n•Mr", bg="white", font="Arial 14")
	f2.place(width=850, height=100, x=0, y=50)
def him3():
	f3 = Label(text="V=n•22.4 (л\моль)", bg="white", font="Arial 14")
	f3.place(width=850, height=100, x=0, y=50)
def him4():
	f4 = Label(text="6,02 · 1023 частиц", bg="white", font="Arial 14")
...
def ff_geo():
	...
	nac.place(width=850, height=40, x=0, y=0)
	geo = IntVar()
	ch1 = Radiobutton(text="Площадь треугольника через две стороны и угол между ними", bg="white", font="Arial 12", value=1, justify=LEFT, command=geo1,
		activebackground="MediumBluE", activeforeground="white", variable=geo)
	ch1.place(width=470, height=20, x=0, y=70)

	ch2 = Radiobutton(text="Площадь треугольника через основание и высоту", bg="white", font="Arial 12", value=2, justify=LEFT, command=geo2,
		activebackground="MediumBluE", activeforeground="white", variable=geo)
	ch2.place(width=380, height=20, x=0, y=90)

	ch3 = Radiobutton(text="Теорема Пифагора", bg="white", font="Arial 12", value=3, justify=LEFT, command=geo3,
		activebackground="MediumBluE", activeforeground="white", variable=geo)
	ch3.place(width=170, height=20, x=0, y=110)

	ch4 = Radiobutton(text="Теорема косинусов", bg="white", font="Arial 12", value=4, justify=LEFT, command=geo4,
		activebackground="MediumBluE", activeforeground="white", variable=geo)
	ch4.place(width=170, height=20, x=0, y=130)

def geo1():
	f1 = Label(text="S = 0,5ab∙sin γ", bg="white", font="Arial 14")
	f1.place(width=850, height=100, x=0, y=50)
def geo2():
	f2 = Label(text="S = 0,5bh", bg="white", font="Arial 14")
	f2.place(width=850, height=100, x=0, y=50)
def geo3():
	f3 = Label(text="a² = b² +c²", bg="white", font="Arial 14")
	f3.place(width=850, height=100, x=0, y=50)
def geo4():
	f4 = Label(text="a² = b² + c² – 2bc∙cos α", bg="white", font="Arial 14")
	f4.place(width=850, height=100, x=0, y=50)
...
def ff_fiz():
	...
	nac.place(width=850, height=40, x=0, y=0)
	fiz = IntVar()
	ch1 = Radiobutton(text="Давление", bg="white", font="Arial 12", value=1, justify=LEFT, command=fiz1,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch1.place(width=90, height=20, x=0, y=70)

	ch2 = Radiobutton(text="Плотность", bg="white", font="Arial 12", value=2, justify=LEFT, command=fiz2,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch2.place(width=97, height=20, x=0, y=90)

	ch3 = Radiobutton(text="Сила тяжести", bg="white", font="Arial 12", value=3, justify=LEFT, command=fiz3,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch3.place(width=120, height=20, x=0, y=110)
	
	ch4 = Radiobutton(text="Сила Архимеда", bg="white", font="Arial 12", value=4, justify=LEFT, command=fiz4,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch4.place(width=135, height=20, x=0, y=130)

	ch5 = Radiobutton(text="Ускорение", bg="white", font="Arial 12", value=5, justify=LEFT, command=fiz5,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch5.place(width=100, height=20, x=0, y=150)

	ch6 = Radiobutton(text="II закон Ньютона", bg="white", font="Arial 12", value=6, justify=LEFT, command=fiz6,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch6.place(width=145, height=20, x=0, y=170)

	ch7 = Radiobutton(text="Закон Гука", bg="white", font="Arial 12", value=7, justify=LEFT, command=fiz7,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch7.place(width=100, height=20, x=0, y=190)

	ch8 = Radiobutton(text="Закон Всемирного тяготения", bg="white", font="Arial 12", value=8, justify=LEFT, command=fiz8,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch8.place(width=230, height=20, x=0, y=210)

	ch9 = Radiobutton(text="Сила трения", bg="white", font="Arial 12", value=9, justify=LEFT, command=fiz9,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch9.place(width=110, height=20, x=0, y=230)

	ch10 = Radiobutton(text="Импульс тела ", bg="white", font="Arial 12", value=10, justify=LEFT, command=fiz10,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch10.place(width=122, height=20, x=728, y=70)

	ch11 = Radiobutton(text="Импульс силы", bg="white", font="Arial 12", value=11, justify=LEFT, command=fiz11,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch11.place(width=122, height=20, x=728, y=90)

	ch12 = Radiobutton(text="Момент силы", bg="white", font="Arial 12", value=12, justify=LEFT, command=fiz12,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch12.place(width=118, height=20, x=732, y=110)

	ch13 = Radiobutton(text="Работа", bg="white", font="Arial 12", value=13, justify=LEFT, command=fiz13,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch13.place(width=80, height=20, x=770, y=130)

	ch14 = Radiobutton(text="Мощность", bg="white", font="Arial 12", value=14, justify=LEFT, command=fiz14,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch14.place(width=95, height=20, x=755, y=150)

	ch15 = Radiobutton(text="Закон преломления света", bg="white", font="Arial 12", value=15, justify=LEFT, command=fiz15,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch15.place(width=215, height=20, x=635, y=170)

	ch16 = Radiobutton(text="Напряжение", bg="white", font="Arial 12", value=16, justify=LEFT, command=fiz16,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch16.place(width=110, height=20, x=740, y=190)

	ch17 = Radiobutton(text="Сила тока", bg="white", font="Arial 12", value=17, justify=LEFT, command=fiz17,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch17.place(width=95, height=20, x=755, y=210)

	ch18 = Radiobutton(text="Закон радиоактивного распада", bg="white", font="Arial 12", value=18, justify=LEFT, command=fiz18,
		activebackground="MediumBluE", activeforeground="white", variable=fiz)
	ch18.place(width=250, height=20, x=600, y=230)

def fiz1():
	f1 = Label(text="Р=F:S", bg="white", font="Arial 14")
	f1.place(width=850, height=100, x=0, y=50)
def fiz2():
	f2 = Label(text="ρ=m:V", bg="white", font="Arial 14")
	f2.place(width=850, height=100, x=0, y=50)
def fiz3():
	f3 = Label(text="Fт=m•g", bg="white", font="Arial 14")
	f3.place(width=850, height=100, x=0, y=50)
def fiz4():
	f4 = Label(text="Fa=ρж•g•Vт", bg="white", font="Arial 14")
	f4.place(width=850, height=100, x=0, y=50)
def fiz5():
	f5 = Label(text="a=(υ-υ 0):t", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz6():
	f5 = Label(text="F=ma", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz7():
	f5 = Label(text="Fy=-kx", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz8():
	f5 = Label(text="F=G∙M∙m/R^2", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz9():
	f5 = Label(text="Fтр=µN", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz10():
	f5 = Label(text="p=mυ", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz11():
	f5 = Label(text="Ft=∆p", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz12():
	f5 = Label(text="M=F∙ℓ", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz13():
	f5 = Label(text="A=F∙S∙cosα", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz14():
	f5 = Label(text="N=A/t=F∙υ", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz15():
	f5 = Label(text="n21=n2/n1= υ 1/ υ 2", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz16():
	f5 = Label(text="U=A/q", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz17():
	f5 = Label(text="I=q/t", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
def fiz18():
	f5 = Label(text="N=N0∙2-t/T", bg="white", font="Arial 14")
	f5.place(width=850, height=100, x=0, y=50)
...
def ff_mat():
	...
	nac.place(width=850, height=40, x=0, y=0)
	mat = IntVar()
	ch1 = Radiobutton(text="Нахождение площади прямоугольника", bg="white", font="Arial 12", value=1, justify=LEFT, command=mat1,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch1.place(width=300, height=20, x=0, y=40)

	ch2 = Radiobutton(text="Нахождение периметра прямоугольника", bg="white", font="Arial 12", value=2, justify=LEFT, command=mat2,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch2.place(width=317, height=20, x=0, y=60)

	ch3 = Radiobutton(text="Нахождение периметра квадрата", bg="white", font="Arial 12", value=3, justify=LEFT, command=mat3,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch3.place(width=268, height=20, x=0, y=80)
	ch4 = Radiobutton(text="Деление с остатком", bg="white", font="Arial 12", value=4, justify=LEFT, command=mat4,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch4.place(width=167, height=20, x=0, y=100)

	ch5 = Radiobutton(text="Формула пути", bg="white", font="Arial 12", value=5, justify=LEFT, command=mat5,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch5.place(width=120, height=20, x=0, y=120)

	ch6 = Radiobutton(text="Формула стоимости", bg="white", font="Arial 12", value=6, justify=LEFT, command=mat6,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch6.place(width=165, height=20, x=0, y=140)

	ch7 = Radiobutton(text="Движение", bg="white", font="Arial 12", value=7, justify=LEFT, command=mat7,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch7.place(width=93, height=20, x=0, y=160)
	ch8 = Radiobutton(text="Переместительное свойство", bg="white", font="Arial 12", value=8, justify=LEFT, command=mat8,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch8.place(width=233, height=20, x=0, y=180)

	ch9 = Radiobutton(text="Сочетательное свойство", bg="white", font="Arial 12", value=9, justify=LEFT, command=mat9,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch9.place(width=205, height=20, x=0, y=200)

	ch10 = Radiobutton(text="Формула работы", bg="white", font="Arial 12", value=10, justify=LEFT, command=mat10,
		activebackground="MediumBluE", activeforeground="white", variable=mat)
	ch10.place(width=145, height=20, x=0, y=220)

def mat1():
	m = open("files\ormuls\matem\Find_area_of_rectangle.txt", "r").read()
	mr1 = Label(text=m, bg="white", font="Arial 14")
	mr1.place(width=850, height=100, x=0, y=50)
def mat2():
	m = open("files\ormuls\matem\Finding_the_perimeter_of_a_rectangle.txt", "r").read()
	mr2 = Label(text=m, bg="white", font="Arial 14")
	mr2.place(width=850, height=100, x=0, y=50)
def mat3():
	m = open("files\ormuls\matem\Finding_the_perimeter_of_a_square.txt", "r").read()
	mr3 = Label(text=m, bg="white", font="Arial 14")
	mr3.place(width=850, height=100, x=0, y=50)
def mat4():
	m = open("files\ormuls\matem\Find_area_of_rectangle.txt", "r").read()
	mr4 = Label(text=m, bg="white", font="Arial 14")
	mr4.place(width=850, height=100, x=0, y=50)
def mat5():
	m = open("files\ormuls\matem\Formula_is_the_way.txt", "r").read()
	mr5 = Label(text=m, bg="white", font="Arial 14")
	mr5.place(width=850, height=100, x=0, y=50)
def mat6():
	m = open("files\ormuls\matem\Formula_cost.txt", "r").read()
	mr6 = Label(text=m, bg="white", font="Arial 14")
	mr6.place(width=850, height=100, x=0, y=50)
def mat7():
	m = open("files\ormuls\matem\Movement.txt", "r").read()
	mr7 = Label(text=m, bg="white", font="Arial 14")
	mr7.place(width=850, height=100, x=0, y=50)
def mat8():
	m = open("files\ormuls\matem\Commutative_property.txt", "r").read()
	mr8 = Label(text=m, bg="white", font="Arial 14")
	mr8.place(width=850, height=100, x=0, y=50)
def mat9():
	m = open("files\ormuls\matem\Associative_property.txt", "r").read()
	mr9 = Label(text=m, bg="white", font="Arial 14")
	mr9.place(width=850, height=100, x=0, y=50)
def mat10():
	m = open("files\ormuls\matem\The_formula_works.txt", "r").read()
	mr10 = Label(text=m, bg="white", font="Arial 14")
...
def ff_alg():
	...
	ch1 = Radiobutton(text="Формулы сокращенного умножения", bg="white", font="Arial 12", value=1, justify=LEFT, command=alg1,
		activebackground="MediumBluE", activeforeground="white", variable=alg)
	ch1.place(width=280, height=20, x=0, y=70)

	ch2 = Radiobutton(text="Квадратное уравнение ax^2+bx+c=0", bg="white", font="Arial 12", value=2, justify=LEFT, command=alg2,
		activebackground="MediumBluE", activeforeground="white", variable=alg)
	ch2.place(width=290, height=20, x=0, y=90)

	ch3 = Radiobutton(text="Арифметическая прогрессия", bg="white", font="Arial 12", value=3, justify=LEFT, command=alg3,
		activebackground="MediumBluE", activeforeground="white", variable=alg)
	ch3.place(width=235, height=20, x=0, y=110)
	
	ch4 = Radiobutton(text="Геометрическая прогрессия", bg="white", font="Arial 12", value=4, justify=LEFT, command=alg4,
		activebackground="MediumBluE", activeforeground="white", variable=alg)
	ch4.place(width=230, height=20, x=0, y=130)

	ch5 = Radiobutton(text="Определение модуля", bg="white", font="Arial 12", value=5, justify=LEFT, command=alg5,
		activebackground="MediumBluE", activeforeground="white", variable=alg)
	ch5.place(width=180, height=20, x=0, y=150)

	ch6 = Radiobutton(text="Простейшие суммы", bg="white", font="Arial 12", value=6, justify=LEFT, command=alg6,
		activebackground="MediumBluE", activeforeground="white", variable=alg)
	ch6.place(width=170, height=20, x=0, y=170)

def alg1():
	ar1 = open("files\pomosh/alg1.txt", "r").read()
	a1 = Label(text=ar1, bg="white", font="Arial 14")
	a1.place(width=850, height=460, x=0, y=50)

def alg2():
	ar2 = open("files\pomosh/alg2.txt", "r").read()
	a1 = Label(text=ar2, bg="white", font="Arial 14")
	a1.place(width=850, height=460, x=0, y=50)

def alg3():
	ar3 = open("files\pomosh/alg3.txt", "r").read()
	a1 = Label(text=ar3, bg="white", font="Arial 14")
	a1.place(width=850, height=460, x=0, y=50)

def alg4():
	ar4 = open("files\pomosh/alg4.txt", "r").read()
	a1 = Label(text=ar4, bg="white", font="Arial 14")
	a1.place(width=850, height=460, x=0, y=50)

def alg5():
	ar5 = open("files\pomosh/alg5.txt", "r").read()
	a1 = Label(text=ar5, bg="white", font="Arial 14")
	a1.place(width=850, height=460, x=0, y=50)

def alg6():
	ar6 = open("files\pomosh/alg6.txt", "r").read()
	a1 = Label(text=ar6, bg="white", font="Arial 14")
	a1.place(width=850, height=460, x=0, y=50)
